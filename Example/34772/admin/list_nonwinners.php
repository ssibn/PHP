...
//Include Page implementation @22-E34C2C5D
include("./header.php");
...
//Operation Method @2-256CC221
    function Operation()
    {
        ...
        $Redirect = "list_nonwinners.php?" . CCGetQueryString("Form", Array("DoSearch","ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "DoSearch") {
                if(!CCGetEvent($this->DoSearch->CCSEvents, "OnClick")) {
                    $Redirect = "";
                } else {
                    $Redirect = "list_nonwinners.php?" . CCGetQueryString("Form", Array("DoSearch"));
                }
            }
        } else {
            $Redirect = "";
...
//Class_Initialize Event @5-94582403
...
//DataSource Variables @5-C88A6C22
    var $CCSEvents = "";
    var $CCSEventResult;
...
//Class_Initialize Event @5-3975F5DA
...
//Prepare Method @5-942E2088
    function Prepare()
    {
        ...
        $this->wp->Criterion[2] = "(  NOT ( Number_1 = Pick_1 OR Number_1 = Pick_2 OR Number_1 = Pick_3 OR Number_1 = Pick_4 ) OR  NOT ( Number_2 = Pick_1 OR Number_2 = Pick_2 OR Number_2 = Pick_3 OR Number_2 = Pick_4 ) )";
        $this->wp->Criterion[3] = "Played='Y'";
...
//Include Page implementation @23-86456262
include("./footer.php");
//End Include Page implementation


//Initialize Page @1-E2915D93
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = "list_nonwinners.php";
$Redirect = "";
$TemplateFileName = "list_nonwinners.html";
$BlockToParse = "main";
$PathToRoot = "../";
//End Initialize Page
