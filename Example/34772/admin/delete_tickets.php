...
$FileName = "delete_tickets.php";
$Redirect = "";
$TemplateFileName = "delete_tickets.html";
$BlockToParse = "main";
$PathToRoot = "../";
//End Initialize Page
...
// Events
include("./delete_tickets_events.php");
BindEvents();
