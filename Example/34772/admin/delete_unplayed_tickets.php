...
$FileName = "delete_unplayed_tickets.php";
$Redirect = "";
$TemplateFileName = "delete_unplayed_tickets.html";
$BlockToParse = "main";
$PathToRoot = "../";
//End Initialize Page
...
// Events
include("./delete_unplayed_tickets_events.php");
BindEvents();
