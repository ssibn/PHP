<?
	...
	switch($_POST['ToDo'])
	{
		...
		case 'UpdatePrefs':
			/* Theme */
			$tmpQuery = "UPDATE preferences SET value = ".$_POST['rdoHistory']." WHERE playerID = ".$_SESSION['playerID']." AND preference = 'theme'";
			mysql_query($tmpQuery);
			
			/* History format */
			$tmpQuery = "UPDATE preferences SET value = ".$_POST['rdoTheme']." WHERE playerID = ".$_SESSION['playerID']." AND preference = 'history'";
			mysql_query($tmpQuery);
