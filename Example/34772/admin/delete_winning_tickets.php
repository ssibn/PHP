...
//Include Page implementation @4-E34C2C5D
include("./header.php");
//End Include Page implementation

//Include Page implementation @5-86456262
include("./footer.php");
//End Include Page implementation


//Initialize Page @1-2E0169AC
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = "delete_winning_tickets.php";
$Redirect = "";
$TemplateFileName = "delete_winning_tickets.html";
$BlockToParse = "main";
$PathToRoot = "../";
//End Initialize Page
...
// Events
include("./delete_winning_tickets_events.php");
BindEvents();
